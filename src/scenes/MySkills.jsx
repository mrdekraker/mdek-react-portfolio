    ...
    <section id="skills" className="pt-10 pb-24">
      ...
      <div className="md:flex md:justify-between md:gap-16 mt-32">
        <motion.div
          ...
          <p className="mt-10 mb-7">
            I excel at the following technologies and tools. I am always open to learning new technologies and tools to improve my skills.
          </p>
        </motion.div>
      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        <motion.div
          ...
          <div className="relative h-32">
            <div className="z-10">
              ...
              <p className="font-playfair font-semibold text-3xl mt-3 hover:text-accent duration-500">
                Experience
              </p>
            </div>
        ...
        <motion.div
          ...
          <div className="relative h-32">
            <div className="z-10">
              <p className="font-playfair font-semibold text-5xl hover:text-accent duration-500">02</p>
              <p className="font-playfair font-semibold text-3xl mt-3 hover:text-accent duration-500">
                Front End
              </p>
            </div>
            ...
            <p className="mt-5 hover:text-accent duration-500">
              CSS, React, Bootstrap, Tailwind, Framer Motion, JavaScript, Handlebars
            </p>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          <div className="relative h-32">
            <div className="z-10">
              <p className="font-playfair font-semibold text-5xl hover:text-accent duration-500">03</p>
              <p className="font-playfair font-semibold text-3xl mt-3 hover:text-accent duration-500">
                Back End
              </p>
            </div>
